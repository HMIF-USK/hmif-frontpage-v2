...
const Contact: React.FC = () => {
  return (
    <main className="w-full border-2 relative">
      <div className="h-[50vh] bg-[#421F69] rounded-t-[2vw] relative flex overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Pattern />
        </div>
        <div className="flex justify-center items-center w-full h-full flex-col relative z-10">
          ...
          <div className="gap-10 flex items-center justify-center my-10">
            <div className="flex justify-center items-center">
              <button className=" w-[10vw] p-4 bg-[#7300FF] rounded-lg font-semibold">
                CONTACT
              </button>
